...
public class Application {
    public static void main(String[] args) {
        ...
        Person person1 =new Person("Ali","Ebrahimi","1380/05/10");
        Person person2 =new Person("Mohsen","Razavi","1368/08/03");
        Person person3 =new Person("Hassan","Bahrami","1370/01/09");
        ...
        Teacher teacher2 = new Teacher("mohsen","vaezzade","1403",170, Degree.BACHELOR, MasterDegree.ASSOCIATEPROFESSOR,102500000L);
       ...
       ApplicationContex.getPersonServiceImpl().save(student);
       ApplicationContex.getPersonServiceImpl().save(student1);
        ApplicationContex.getPersonServiceImpl().save(student2);
        ApplicationContex.getPersonServiceImpl().save(student3);
       ApplicationContex.getPersonServiceImpl().save(teacher);
        ApplicationContex.getPersonServiceImpl().save(teacher1);
        ApplicationContex.getPersonServiceImpl().save(teacher2);
        ...
        System.out.println(ApplicationContex.getStudentServiceImpl().signUp(210, "Mechanic"));
